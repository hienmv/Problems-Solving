...
2 0 2 0 6
6 9 9 8 8 7 7
9 9 8 8 7 7 9 9 8 8 7 7

/* 
1. approaching: count number of non-ascent sequences
    isAscent:
        exists
    
(A) = ways of p + q: nonAscent -> nonAscent
    nonAscent:
        minP >= maxQ
            non-increasing
...
2. approaching: count number of ascent sequences
for each sequence:
    if isAscent:
        calculate:
        ...
        append min value to minArray
        append max value to maxArray

sort maxArray
for each element in minArray:
    find upperBound in maxArray
*/
