...
class VirtualFriends {
    ...
    public static int getIndex(HashMap<String, Integer> hashFriendIndex, ArrayList<String> peopleArr, String person, 
    ArrayList<Integer> parentArr, ArrayList<Integer> sizeArr) {
    ...
    public static int unionSet(ArrayList<Integer> parentArr, ArrayList<Integer> sizeArr, int u, int v) {
