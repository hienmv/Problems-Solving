...
class TheClosestPairProblem {
    ...
    public static double stripCloset(ArrayList<Point> arr, int left, int right, int mid, double dist_min) {
        ...
        for (int i=0; i < l; i++) {
            for (int j=i+1; j < l && splittedPointArr.get(j).y - splittedPointArr.get(i).y < dist_min; j++) {
