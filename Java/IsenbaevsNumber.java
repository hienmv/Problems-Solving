...
public class IsenbaevsNumber {
    public static int getIdx(HashMap<String, Integer> hashMap, 
    ArrayList<String> arr, ArrayList<ArrayList<Integer>> graph, String name)
    {
    ...
    public static void BFS(ArrayList<ArrayList<Integer>> graph, ArrayList<Integer> dist, ArrayList<Boolean> visitedArr, int startNode) {
