/**
 * https://codeforces.com/problemset/problem/1143/C #dfs only check vertices that can be deleted.
 */
...
public class Queen {
  ...
  public static void main(String args[]) {
    ...
    int n = sc.nextInt();
    int[] canBeDeletedArr =
        new int[n + 1]; // -1 : can not be deleted, 0: initilize, 1: can be deleted.
    for (int i = 1; i < n + 1; i++) {
